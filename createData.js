...
const payees = {
    food: ["EDEKA", "REWE", "ALDI", "DM"],
    transportation: ["RYANAIR", "HVV", "CAR"],
    hobbies: ["CINEMA", "COFFEE", "DINNER"],
    personal_spending: ["C&A", "DEICHMANN"],
    //housing: ["RENT"],
    //utilities: ["WATER", "ELECTRICITY", "TV", "INTERNET"],
};

async function generateEntries(category, entry) {
